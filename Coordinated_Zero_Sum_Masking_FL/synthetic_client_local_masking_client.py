"""Dataset-I client for the independent Client-Local Masking baseline."""
...
LOG_DIR = "/home/ripon/code/client_local_masking_synthetic_logs"
...
class FlowerClient(NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        print(
            f"[Client {self.partition_id}] client-local masking: "
            f"{int(selection.sum())}/{selection.size} coordinates; "
            f"mask sum={float(masking_vector.sum()):.6e}"
        )
